...
import com.tim.gulimall.search.feign.ProductFeignService;
import com.tim.gulimall.search.service.MallSearchService;
import com.tim.gulimall.search.vo.AttrResponseVo;
import com.tim.gulimall.search.vo.BrandVo;
        ...
        if (!StringUtils.isEmpty(param.getSkuPrice())) {
            ...
            if (s.length == 2) {
                if (param.getSkuPrice().startsWith("_")) {
                    rangeQuery.lte(Double.parseDouble(s[1]));
                } else {
...
//
    ...
    private String replaceQueryString(SearchParam param, String value, String key) {
        ...
        if (param.getQueryString().contains("&")) {
